...
export default function () {
  ...
  if (!user) {
    return (
      <div className="bg-neutral-50 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-50 rounded-lg p-6 h-fit">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            className="flex gap-2 items-center justify-center p-2 dark:text-neutral-900 text-neutral-50 text-sm bg-neutral-900 dark:bg-neutral-50 w-full rounded-lg hover:bg-opacity-75 transition-colors"
  ...
  return (
    <div className="bg-neutral-50 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-50 rounded-lg p-6 h-fit">
      <div className="flex items-center gap-2">
        <UserImage size={48} image={user.picturePath} />
        <div className="flex flex-col">
          <span className="text-base">{user.username}</span>
          <span className="text-sm opacity-40">{followerCount} followers</span>
        </div>
      </div>
      <Divider />
      <div className="flex flex-col gap-2">
        ...
        <div className="flex justify-between items-center">
          <span className="text-xs opacity-40">Content you have uploaded</span>
      ...
      <div>
        ...
        <div>
          {user.games ? (
            <span className="text-sm opacity-40">No favorite games yet.</span>
          ) : (
